...
The current canonical AMAS framework version is **v3.0.4** (in development in this repository). The latest published release is **v3.0.0** — the adopter-facing version of record: adopters should reference the published **v3.0.0** git tag, governed by this version-positioning note, until the v3.1 release. (The v3.0.0 git tag is published; no GitHub release page is published for v3.0.0 — adopters reference the git tag directly.)
