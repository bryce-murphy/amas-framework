...
The current canonical AMAS framework version is **v2.39**, materialized in the UPCDS reference project. Until v3 publishes from this repository, adopters should reference v2.39.
...
| `templates/ISSUE_TEMPLATE/chore.md` | Chore Issue template | Batch P2 (ADR-008); pending content-fill cycle TASK-0044 |
| `templates/ISSUE_TEMPLATE/retrospective.md` | PMN companion Issue template | Batch P2 (ADR-008); pending content-fill cycle TASK-0044 |
