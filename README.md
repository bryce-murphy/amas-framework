...
The current canonical AMAS framework version is **v2.33**, materialized in the UPCDS reference project. Until v3 publishes from this repository, adopters should reference v2.33.
