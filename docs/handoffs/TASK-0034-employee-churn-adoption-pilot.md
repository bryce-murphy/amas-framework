...
- **(XVII-XX expected)**: standard cycle-close ledger entries surfaced during post-PR Codex absorption + (XXVI) two-gate §24.3.1 discipline 3rd-instance test + owner merge gate.
